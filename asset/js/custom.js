$(function(){
    ScrollTrigger.matchMedia({
        ...
        "all": function() {
        // 3. gsap load화면, 제목,버튼,svg // gsap 스크롤트리거 img,text영역    
            ...
            // 6. sc-selection 텍스트 애니메이션 - each문 활용
